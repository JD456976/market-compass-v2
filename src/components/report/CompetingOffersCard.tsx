/**
 * Competing Offer Simulator Card — interactive tool for modeling competitive scenarios.
 * Works for both buyer (simulate competitors) and seller (estimate demand) reports.
 */
...
import { Swords, Users, TrendingUp, Shield, AlertTriangle } from 'lucide-react';
...
const POSITION_COLORS: Record<string, string> = {
  'Dominant': 'text-emerald-600 dark:text-emerald-400',
  'Strong': 'text-emerald-600 dark:text-emerald-400',
  'Competitive': 'text-accent',
  'Weak': 'text-destructive',
  'Outmatched': 'text-destructive',
};
...
export function BuyerCompetingOffersCard({ inputs, snapshot, className }: BuyerCompetingOffersCardProps) {
...
export function SellerCompetingOffersCard({ inputs, likelihood30, snapshot, className }: SellerCompetingOffersCardProps) {
