...
export const reportTitles = {
  ...
  client: {
    riskTradeoff: 'Offer Considerations',
    riskOfLosingHome: 'Competitiveness Factor',
    riskOfOverpaying: 'Value Protection Factor',
    acceptanceLikelihood: 'Offer Strength Assessment',
    saleLikelihood: 'Market Timing Analysis',
    whatThisMeans: 'Key Insights',
    tradeoffSummary: 'Important Considerations',
  },
};
